...
export default function Feed() {
  return (
    ...
    <div class=" rounded mb-5 overflow-hidden border w-full bg-white mx-3 md:mx-0 lg:mx-0">
      <div class="w-full flex justify-between p-3 shadow-lg">
        ...
        <span class="px-2 cursor-pointer rounded">
          ...
          <button
            href="#_"
            class="inline-flex items-center justify-center px-4 py-1 text-base font-medium leading-6 text-white whitespace-no-wrap bg-brand-600 border border-brand-700 rounded-md shadow-sm hover:bg-brand-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500"
